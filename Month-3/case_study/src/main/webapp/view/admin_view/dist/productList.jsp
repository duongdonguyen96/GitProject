                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Product Details</h2>
                                    <div class="create">
                                        <a href="${pageContext.request.contextPath}/product?action=create"><h5>Create
                                            New
                                            Product</h5></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="search-box">
                                        <form action="${pageContext.request.contextPath}/product?action=search"
                                              method="post">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th>Price <a href="${pageContext.request.contextPath}/product?action=sort">
                                </a></th>
                                <th>Description</th>
                                <th>Name</th>
                                <th>Amount</th>
                                <th>Image <a href="${pageContext.request.contextPath}/product?action=sort">
                                </a></th>
                                <th>Amount Sold</th>
                                <th>Evaluate</th>
                                <th>Discount</th>
                            ...
                            <c:forEach var="product" items="${productList}">
                                <tr>
                                    ...
                                    <td><img src="<c:url value="${product.image}"/>" alt="anh"></td>
                                        <%--                                    <td><c:out value="${product.image}"/></td>--%>
                                    <td><c:out value="${product.amountSold}"/></td>
                                    <td><c:out value="${product.evaluate}"/></td>
                                    <td><c:out value="${product.discount}"/></td>
                                    <td><c:out value="${product.type.name}"/></td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/home?action=view&id=${product.id}"
                ...
                <ul class="pagination pagination-lg">
                    <c:forEach begin="1" end="${item.numberPage}" var="item">
                        <li class=page-item><a class="page-link"
                                               href="${pageContext.request.contextPath}/product?action=paging&index=${item}">${item}</a>
                        </li>
                    </c:forEach>
                </ul>
            </div>
...
<script>
    function deleteProduct(id) {
        let showMessage = confirm("Bạn có muốn xóa sản phẩm có id " + id +
            " không?"
            )
        ;
        if (showMessage) {
