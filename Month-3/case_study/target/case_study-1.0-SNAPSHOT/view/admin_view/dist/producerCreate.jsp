...
<div class="signup-form">
    <form method="post" action="">
        ...
        <p class="hint-text">Create new producer. It's free and only takes a minute.</p>
    ...
    <div class="text-center"><a href="${pageContext.request.contextPath}/producer?action=list">Back to List
        Customer</a>
    </div>
</div>
</body>
