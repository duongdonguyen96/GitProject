        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="${pageContext.request.contextPath}/product?action=paging">
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Producer Details</h2>
                                    <div class="create">
                                        <a href="${pageContext.request.contextPath}/producer?action=create"><h5>Create
                                            New
                                            Producer</h5></a>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="search-box">
                                        <%--                                        <form action="${pageContext.request.contextPath}/producer?action=search"--%>
                                        <%--                                              method="post">--%>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            <thead>
                            <tr>
                                <th>ID<i class="fa fa-sort"></i>
                                </th>
                                <th>Name <a href="${pageContext.request.contextPath}/producer?action=sort"><i
                            ...
                            <c:forEach var="producer" items="${producerList}">
                                <tr>
                                    ...
                                    <td><c:out value="${producer.phone}"/></td>
                                    <td><c:out value="${producer.address}"/></td>
                                    <td>
                                        <a href="#"
                                           class="view" title="View" data-toggle="tooltip"><i
                                                class="material-icons">&#xE417;</i></a>
                                        <a href="${pageContext.request.contextPath}/producer?action=edit&id=${producer.id}"
                                           class="edit"
                                           title="Edit" data-toggle="tooltip"><i
                                                class="material-icons">&#xE254;</i></a>
                                        <a href="#" onclick="deleteProduct(${producer.id})"
...
<script>
    function deleteProduct(id) {
        let showMessage = confirm("Bạn có muốn xóa Nhà Sản Xuất có id " + id +
            " không?"
            )
        ;
        if (showMessage) {
            alert("Xóa thành công")
            window.location = "/producer?action=delete&id=" + id;
        } else {
