                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-8"><h2>Type Details</h2>
                                    <div class="create">
                                        <a href="${pageContext.request.contextPath}/type?action=create"><h5>Create
                                            New
                                            Type</h5></a>
                                    </div>
                                </div>
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tr>
                                ...
                                <th>Name <a href="${pageContext.request.contextPath}/type?action=sort"><i
                            ...
                            <c:forEach var="type" items="${typeList}">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="${pageContext.request.contextPath}/type?action=edit&id=${type.id}"
                                           class="edit"
                                           title="Edit" data-toggle="tooltip"><i
                                                class="material-icons">&#xE254;</i></a>
                                        <a href="#" onclick="deleteProduct(${type.id})"
...
<script>
    function deleteProduct(id) {
        let showMessage = confirm("Bạn có muốn xóa Thể Loại có id " + id +
            " không?"
            )
        ;
        if (showMessage) {
            alert("Xóa thành công")
            window.location = "/type?action=delete&id=" + id;
        } else {
